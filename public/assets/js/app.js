...
+function($){
  ...
  provider.list = {
    ...
    selectTagsinput: {
      selector: 'selectTagsinput',
      callback: 'initSelectTagsinput',
      css:      'bootstrap-tagsinput/bootstrap-tagsinput.css',
      js:       'bootstrap-tagsinput/bootstrap-tagsinput.min.js',
    },
    ...
    */
    ...
    datatables: {
      ...
      css:      [
        ...
        'datatables/css/select.dataTables.min.css',
      ],
      js:       [
                  'datatables/js/jquery.dataTables.min.js',
                  'datatables/js/dataTables.bootstrap4.min.js',
                  'datatables/js/dataTables.select.min.js',
                ]
    },

    datatablesdefault: {
      selector: 'datatablesdefault',
      callback: 'initDatatablesDefault',
...
+function($){
  ...
  provider.initTagsinput = function() {
    ...
    provider.provide('tagsinput', function(){
      if($(this).dataAttr("option-provider") !== undefined){
        $(this).tagsinput({
          tagClass: function(item) {
            switch (item.text) {
              case 'Todas'   : return 'badge-danger';
...
+function($){
  ...
  provider.initDatatables = function() {
    ...
    provider.provide('datatables', function(){
      $(this).DataTable($_DATATABLE_OPTIONS_);
    });

  };


  provider.initDatatablesDefault = function() {
    if ( ! $.fn.DataTable ) {
      return;
    }

    provider.provide('datatablesdefault', function(){
      $(this).DataTable();
    });
