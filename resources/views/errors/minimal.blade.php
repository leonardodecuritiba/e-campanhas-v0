...
<div class="row no-margin h-fullscreen" style="padding-top: 10%">
    ...
    <div class="col-12">
        <div class="card card-transparent mx-auto text-center">
            <h1 class="text-secondary lh-1" style="font-size: 200px">@yield('code')</h1>
            <hr class="w-30px">
    ...
    <footer class="col-12 align-self-end text-center fs-13">
        <p>Copyright © {{date('Y')}} <a href="http://thetheme.io/theadmin">{{config("app.name")}}</a>. Todos os direitos reservados.</p>
    </footer>
</div>
