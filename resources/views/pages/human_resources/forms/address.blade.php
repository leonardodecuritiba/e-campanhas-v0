...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        {{Form::select('state_id', $Page->auxiliar['states'], old('state_id',(isset($Address) ? $Address->state_id : '')), ['placeholder' => 'Escolha o Estado', 'class'=>'form-control select2_single','id' => 'select-state', 'required'])}}
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        {!! Html::decode(Form::label('city_code', 'Código IBGE', array('class' => 'col-form-label'))) !!}
        {{Form::text('city_code', old('city_code', (($Address != null) ? $Address->city_code : '')), ['class'=>'form-control', 'maxlength'=>'10'])}}
    </div>
</div>
