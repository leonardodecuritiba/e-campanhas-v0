...
@section('body_content')
    ...
    <div class="col-12">
        <div class="card card-shadowed px-50 py-30 w-400px mx-auto" style="max-width: 100%">
            <h5 class="text-uppercase">{{ config('app.name', 'Audite')." - ".config('app.version') }}</h5>
            <br>
            ...
            <form class="form-horizontal" data-provide="validation" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group flexbox flex-column flex-md-row">
                    ...
                    <a class="text-muted hover-primary fs-13 mt-2 mt-md-0" href="{{ route('password.request') }}">{{__('Esqueceu a Senha?')}}?</a>
                </div>
